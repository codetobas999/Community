...
def maindata():
    ...
    blanklabel.pack()
    button1 = Button(app1, font=('tahoma', '11'), text='เพิ่มรายการสินค้า',
                     height=1, width=20, command=cake)
    button1.pack()
    button2 = Button(app1, font=('tahoma', '11'), text='เพิ่มจำนวนสินค้า',
                     height=1, width=20, command=adds)
    button2.pack()
    button3 = Button(app1, font=('tahoma', '11'), text='รายงานสินค้า',
                     height=1, width=20, command=lists)
    button3.pack()
    button4 = Button(app1, font=('tahoma', '11'), text='ออกจากระบบ',
