...
def productdata(root1):
    ...
    idlabel = Label(app2, text="รหัสสินค้า", font=('tahoma', '11'), width=15, anchor=W)

    identry = Label(app2, fg="#fff", bg="blue", font=('tahoma', '11'), width=10, anchor=W)

    namelabel = Label(app2, text="ชื่อสินค้า", font=('tahoma', '11'), width=15,  anchor=W)

    nametext = StringVar()
    nameentry = Entry(app2, textvariable=nametext, font=('tahoma', '11'), width=10)

    alabel = Label(app2, text="จำนวนสินค้าคลัง A", font=('tahoma', '11'), width=15, anchor=W)

    atext = StringVar()
    aentry = Entry(app2, textvariable=atext, font=('tahoma', '11'), width=10)

    blabel = Label(app2, text="จำนวนสินค้าคลัง B", font=('tahoma', '11'), width=15, anchor=W)

    btext = StringVar()
    bentry = Entry(app2, textvariable=btext, font=('tahoma', '11'), width=10)

    savebutton = Button(app2, text='บันทึก', font=('tahoma', '11'), width=10,
                        command=lambda: insertproduct())
    backbutton = Button(app2, text='กลับ', font=('tahoma', '11'), width=10,
...
def transferdata(root1):
    ...
    idlabel = Label(app3, text="รหัสหนังสือ", font=('tahoma', '11'), width=15, anchor=W)

    identry = Label(app3, bg="yellow", font=('tahoma', '11'), width=15)
    namelabel = Label(app3, text="ชื่อหนังสือ", font=('tahoma', '11'), width=15, anchor=W)

    nameentry = Label(app3, bg="silver", font=('tahoma', '11'), width=15)
    alabel = Label(app3, text="จำนวนสินค้าคลัง A", font=('tahoma', '11'), width=15, anchor=W)

    aentry = Label(app3, bg="yellow", font=('tahoma', '11'), width=15)
    blabel = Label(app3, text="จำนวนสินค้าคลัง B", font=('tahoma', '11'), width=15, anchor=W)

    bentry = Label(app3, bg="silver", font=('tahoma', '11'), width=15)
    var = IntVar()
    r1 = Radiobutton(app3, text="A -> B", font=('tahoma', '11'), variable=var, value=1,
                     command=lambda: gettransferid())
    r2 = Radiobutton(app3, text="B -> A", font=('tahoma', '11'), variable=var, value=2,
                     command=lambda: gettransferid())
    tidlabel = Label(app3, text="เลขที่การ่โอนย้าย", font=('tahoma', '11'), width=15, anchor=W)

    tidtext = StringVar()
    tidentry = Entry(app3, textvariable=tidtext, fg="#fff", bg="blue", font=('tahoma', '11'), width=15)

    transfertext = StringVar()
    transferlabel = Label(app3, text="จำนวนที่โอนย้าย", font=('tahoma', '11'), width=15, anchor=W)

    transferentry = Entry(app3, textvariable=transfertext, font=('tahoma', '11'), width=15)

    listbox1 = Listbox(app3, font=('tahoma', '11'), height=5, width=30)
    addbutton = Button(app3, text='...', font=('tahoma', '11'), width=10,
                       command=lambda: displayproduct(ACTIVE))
    savebutton = Button(app3, text='บันทึก', font=('tahoma', '11'), width=10,
                        command=lambda: inserttransfer(ACTIVE))
    backbutton = Button(app3, text='กลับ', font=('tahoma', '11'), width=15,
...
def transferlist(root1):
    ...
    var = IntVar()
    r1 = Radiobutton(app4, text="คลัง A", font=('tahoma', '11'), variable=var, value=1,
                     command=lambda: gettransferlist())
    r2 = Radiobutton(app4, text="คลัง B", font=('tahoma', '11'), variable=var, value=2,
                     command=lambda: gettransferlist())
    listbox1 = Listbox(app4, font=('tahoma', '11'), height=15, width=45)
    backbutton = Button(app4, text='กลับ', font=('tahoma', '11'), width=10,
...
def maindata():
    ...
    blanklabel.pack()
    button1 = Button(app1, font=('tahoma', '11'), text='ข้อมูลสินค้า', height=1, width=20,
                     command=lambda: productdata(root1))
    button1.pack()
    button2 = Button(app1, font=('tahoma', '11'), text='ทำรายการโอนย้าย', height=1, width=20,
                     command=lambda: transferdata(root1))
    button2.pack()
    button3 = Button(app1, font=('tahoma', '11'), text='ข้อมูลการโอนย้าย', height=1, width=20,
                     command=lambda: transferlist(root1))
    button3.pack()
    button4 = Button(app1, font=('tahoma', '11'), text='ออกจากระบบ', height=1, width=20,
                     command=sys.exit)
    button4.pack()
    root1.mainloop()
