...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tlabel.setGeometry(QtCore.QRect(260, 20, 37, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft Sans Serif")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.emplabel.setGeometry(QtCore.QRect(40, 160, 381, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft Sans Serif")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.datalist.setGeometry(QtCore.QRect(40, 200, 381, 331))
        font = QtGui.QFont()
        font.setFamily("Microsoft Sans Serif")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.savebutton.setGeometry(QtCore.QRect(230, 120, 97, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft Sans Serif")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.closebutton.setGeometry(QtCore.QRect(330, 120, 97, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft Sans Serif")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.utext.setGeometry(QtCore.QRect(130, 20, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft Sans Serif")
        font.setPointSize(10)
