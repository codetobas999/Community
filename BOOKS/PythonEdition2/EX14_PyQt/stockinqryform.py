...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.showlist.setGeometry(QtCore.QRect(30, 20, 491, 491))
        font = QtGui.QFont()
        ...
        self.closebutton.setGeometry(QtCore.QRect(495, 520, 25, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft Sans Serif")
        font.setPointSize(10)
        font.setBold(False)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Stock In List"))
