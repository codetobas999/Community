...
export default {
    data(){
        return{
            menus:[ 
               /* {id:1000, name:"หน้าแรก",title:"หน้าแรก",link:"/home",icon:"mdi-database",isAuthen:true},
                {id:2000, name:"บทความ",title:"บทความ",link:"/post",icon:"mdi-format-list-checks",isAuthen:true},
                {id:3000,name:"ผู้เขียน",title:"ผู้เขียน",link:"/admin",icon:"mdi-database-lock",isAuthen:true}, */

                {id:1000, name:"หน้าแรก", title: 'หน้าแรก',icon: 'mdi-database',isAuthen:true,
                  pages: [ {title: 'หน้าแรก1', icon: 'mdi-format-list-checks', link: '/home',isAuthen:true},
                           {title: 'หน้าแรก2', icon: 'mdi-format-list-checks', link: '/home',isAuthen:true},
                         ]  
                },
                {id:2000, name:"บทความ", title: 'บทความ',icon: 'mdi-database',isAuthen:true, 
                  pages: [ {title: 'บทความ1', icon: 'mdi-format-list-checks', link: '/post',isAuthen:true},
                           {title: 'บทความ2', icon: 'mdi-format-list-checks', link: '/post',isAuthen:true},
                         ]  
                },    
                {id:3000, name:"ผู้เขียน", title: 'ผู้เขียน',icon: 'mdi-database',isAuthen:true, 
                  pages: [ {title: 'ผู้เขียน1', icon: 'mdi-format-list-checks', link: '/admin',isAuthen:true},
                           {title: 'ผู้เขียน2', icon: 'mdi-format-list-checks', link: '/admin',isAuthen:true},
                         ]  
                },                             
            ]    
        }     
