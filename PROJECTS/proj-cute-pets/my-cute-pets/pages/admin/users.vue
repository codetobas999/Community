<template>
    ...
    >
      <template v-slot:top>
        <v-toolbar
          flat
        >
          <v-toolbar-title>User All</v-toolbar-title>
          <v-divider
            class="mx-4"
            inset
            vertical
    ...
    methods: {
      async initialize () {
        ...
        this.desserts  = await Users.queryAll()
      ...
      async deleteItemConfirm () {
        console.log("Delete")
        const data = await Users.destroy(this.editedItem.user_id) 
        console.log(data)
      ...
      async save () {
        ...
        if (this.editedIndex > -1) {
          ...
          const data = await Users.update(this.editedItem) 
          console.log(data) 
        } else {
          console.log("Create") 
          console.log(this.editedItem)
          const data = await Users.create(this.editedItem)   
